...
class OrderCancelUnsuccessful extends StatefulWidget {
  const OrderCancelUnsuccessful({Key? key}) : super(key: key);

  @override
  _OrderCancelUnsuccessfulState createState() =>
      _OrderCancelUnsuccessfulState();
}

class _OrderCancelUnsuccessfulState extends State<OrderCancelUnsuccessful> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              text("Cancel Order Unsuccessful",
