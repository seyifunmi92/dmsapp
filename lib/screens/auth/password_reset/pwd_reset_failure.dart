...
class PWDResetFailure extends StatelessWidget {
  const PWDResetFailure({Key? key}) : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              text("Password Reset Failed", fontSize: 17.0, textColor: appTextColorSecondary),
              SizedBox(
